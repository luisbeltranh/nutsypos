    ...
    <div class="sidebar-wrapper">
        <nav class="mt-2"> <!--begin::Sidebar Menu-->
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="<?php echo $menu_activo == 'productos' ? '#' : base_url('dashboard/productos'); ?>" class="nav-link <?php echo $menu_activo == 'productos' ? 'active' : ''; ?>"> <i class="nav-icon bi bi-columns-gap"></i>
                        <p>Productos</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo $menu_activo == 'productos_granel' ? '#' : base_url('dashboard/verproductosgranel'); ?>" class="nav-link <?php echo $menu_activo == 'productos_granel' ? 'active' : ''; ?>"> <i class="nav-icon bi bi-columns-gap"></i>
                ...
                ?>
                    ...
                    <li class="nav-item">
                        <a href="<?php echo $menu_activo == 'veringresos' ? '#' : base_url('dashboard/veringresos'); ?>" class="nav-link <?php echo $menu_activo == 'veringresos' ? 'active' : ''; ?>"> <i class="nav-icon bi bi-columns-gap"></i>
                            <p>Ver Ingresos.</p>
                        </a>
                    </li>
                <?php
                ...
                ?>
                <li class="nav-item">
                    <a href="<?php echo $menu_activo == 'agregarembolsadogranel' ? '#' : base_url('dashboard/agregarembolsadogranel'); ?>" class="nav-link <?php echo $menu_activo == 'agregarembolsadogranel' ? 'active' : ''; ?>"> <i class="nav-icon bi bi-columns-gap"></i>
                        <p>Embolsar</p>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a href="<?php echo $menu_activo == 'ver_granel' ? '#' : base_url('dashboard/verinventariogranel'); ?>" class="nav-link <?php echo $menu_activo == 'ver_granel' ? 'active' : ''; ?>"> <i class="nav-icon bi bi-columns-gap"></i>
