                ...
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                            ...
                            $color_actual = 'table-secondary';
                            foreach ($ventas as $venta) {
                                if ($venta['numero_venta'] != $id_venta_anterior) {
                                    $color_actual = ($color_actual == 'table-secondary') ? 'table-light' : 'table-secondary';
                                }
                            ...
                            <?php
                                $id_venta_anterior = $venta['numero_venta'];
                            }
                            ?>
                            <tr>
                                <td>Venta Total</td>
                                <td><?= $venta_forma_total[1] + $venta_forma_total[2]; ?></td>
