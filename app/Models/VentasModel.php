...
class VentasModel extends Model
{
    ...
    {
        return $this->select('*, ventas.id AS id_venta, ventas.created_at AS fecha_venta, productos.nombre AS producto_nombre, formas_pago.nombre AS forma_pago_nombre')->where('ventas.created_at BETWEEN "' . $fecha_inicio . '" AND "' . $fecha_fin . '"')->join('productos', 'productos.id = ventas.producto_id')->join('formas_pago', 'formas_pago.id = forma_pago_id')->orderBy('numero_venta', 'ASC')->findAll();
    }
}
